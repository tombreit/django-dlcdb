        ...
        for device in Device.objects.all():
            ...
            if hasattr(device_records.first(), "record_type"):
                ...
                if all([
                    ...
                    print(80 * "~")
                    result.append(f"Device '{device}', manufacturer '{device.manufacturer}', series '{device.series}', lender: '{previous_record.person}")

                    print(f"+ current_lost_record: {current_lost_record}, {current_lost_record.record_type}")
                    print(f"+ previous_record:     {previous_record}, {previous_record.record_type}, {previous_record.person}")
